...
import com.example.upm.androidthings.driverlibrary.LSM303DLHCAccelerometerDriver;
...
public class AccelerometerActivity extends Activity implements SensorEventListener {
    ...
    private LSM303DLHCAccelerometerDriver mAccelerometerDriver;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mAccelerometerDriver = new LSM303DLHCAccelerometerDriver(0);    // Use the index lookup function for the bus
