...
import upm_lsm303.LSM303;


public class LSM303DLHCAccelerometerDriver implements AutoCloseable{

    private static String TAG = LSM303DLHCAccelerometerDriver.class.getSimpleName();
    private static String DRIVER_NAME = "Ultra compact high performance e-compass: 3D accelerometer and 3D magnetometer module";
    private static String DRIVER_VENDOR = "ST";
     ...
     * @see #register()
     */
    public LSM303DLHCAccelerometerDriver(int bus) throws IOException {
        mDevice = new LSM303(bus);
    }
    ...
    static UserSensor build(final LSM303 lsm303) {
        return UserSensor.builder()
                ...
                .setDriver(new UserSensorDriver() {
                    ...
                    public UserSensorReading read() throws IOException {
                        float[] sample = {(float)lsm303.getAcceleration()};
                    ...
                    public void setEnabled(boolean enabled) throws IOException {
                        if (enabled) {
                            // not feature to enable or disable the lsm303
                            //lsm303.setModeActive();
                        } else {
                            //lsm303.setModeStandby();
                        }
                    }
                })
                .build();
