...
public class ImageClassifierActivity extends Activity {
    ...
    private static final String BUTTON_PIN = "DISPLAY_0_BIAS_EN";
    private static final String LED_PIN = "DISPLAY_0_RST_N";
    ...
    private void init() {
        //try {
            //mButtonDriver = new ButtonInputDriver(BUTTON_PIN, Button.LogicState.PRESSED_WHEN_HIGH,
    ...
    public void onImageAvailable(Bitmap bitmdap) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mImage.setImageBitmap(Out_bitmap);
            }
        });
